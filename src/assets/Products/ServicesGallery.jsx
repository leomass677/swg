...
const ServicesGallery = () => {
  ...
  return (
    <div
      ...
      className="min-h-screen  relative py-16 pb-24 px-4  bg-dark/90 "
    >
      {/* overlay */}
      {/* Header */}
      <div>
        ...
        >
          <h1 className="text-6xl font-bold text-blue-500 mb-6">Our Product</h1>
              ...
              <button
                ...
                className={`px-4 cursor-pointer hover:scale-105 py-2 rounded-full capitalize transition-all duration-300 ${
                  activeCategory === category
                    ? "bg-blue-500 scale-105 text-white shadow-lg shadow-blue-500/25"
                    : "bg-shade/15 backdrop-blur-sm text-gray-300 hover:bg-white/20"
                }`}
              >
                {category}
              </button>
          ...
          {/* <div className="flex gap-2 bg-shade/15 rounded-lg p-1">
            <button
              ...
              className={`p-2 px-4 rounded transition-all ${
                isGridView ? "bg-blue-500 text-white" : "text-gray-300"
              }`}
            >
              Grid
            </button>
          ...
          {filteredServices.map((service, index) => (
            <motion.div
              ...
              className={`group cursor-pointer ${
                isGridView
                  ? "aspect-[4/3]"
                  : "flex items-center gap-6 p-6 bg-white/5 rounded-2xl hover:bg-white/10"
              }`}
          ...
          >
            ...
            >
              <div className="relative h-80 bg-gray-700">
                ...
                <button
                  onClick={() => setSelectedService(null)}
                  className="absolute top-4 right-4 cursor-pointer w-10 h-10 bg-black/50 rounded-full flex items-center justify-center text-white hover:bg-black/70 transition-colors"
                >
                  <IoClose />
                </button>
              </div>
